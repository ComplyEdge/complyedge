...
**Article 5 is already law.** GPAI fines start August 2, 2026 — and Article 50 transparency binds the companies that build and deploy AI systems the same day. If you ship a chatbot or publish AI-generated content, that clock is yours, not just your model provider's. Your AI is either compliant right now, or it isn't.
