...
**Status:** Methodology v1.0 — published with the initial IPI rule category (2026-05-15). Corpus expansion (rules 3-10+) and Layer 2 behavioral clause ship in follow-up cards.
