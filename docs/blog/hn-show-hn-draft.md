...
Regulators need citation chains, not probability scores. Article 5(1)(c) is a binary legal classification, not a confidence interval. A rule engine that says "Article 5(1)(c), rule rego-art5-1c-001, timestamp, input hash" is auditable. "The model said 0.87" isn't. The blog post covers this in depth.
...
19 Rego policies + 53 YAML rules across 4 jurisdictions. EU covers Articles 4–6, 9–10, 12–16, 26–27, 50, 53, GPAI, GDPR. US covers HIPAA, SOX, COPPA, TCPA, BIPA, CCPA, Colorado AI Act, NYC LL144, ECPA. Plus PCI DSS and prompt injection detection. Curated, not exhaustive — open source means community PRs fill the gaps. CONTRIBUTING.md explains the format.
