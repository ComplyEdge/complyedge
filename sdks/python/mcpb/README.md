...
- **Runtime (local only):** `uvx --from 'complyedge[mcp]==0.2.8' -- python -m complyedge.mcp_server`
...
- **Official Registry twin:** `io.github.ComplyEdge/complyedge` @ 0.2.8
...
cd sdks/python/mcpb
./pack.sh
# writes ../dist/complyedge-trustlint-0.2.8.mcpb
```
...
uvx --from 'complyedge[mcp]==0.2.8' -- python -m complyedge.mcp_server
```
